...
def get_supabase_sql_migration():
    """Returns the SQL query to create the required 'users' table and storage bucket in Supabase."""
    return """-- =========================================================
-- Supabase Setup Script for Telegram Bot & Image Storage
...
-- 3. Create 'user-images' storage bucket if it does not exist
INSERT INTO storage.buckets (id, name, public)
VALUES ('user-images', 'user-images', true)
ON CONFLICT (id) DO UPDATE SET public = true;

-- 4. Enable public read and write access for 'user-images' storage bucket
DO $$
BEGIN
    IF NOT EXISTS (
